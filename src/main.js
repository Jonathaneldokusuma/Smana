...
const seedFacilities = [
  ...
  // Kepulauan terpencil
  { name: 'RSUD Natuna', latlng: [3.9330, 108.3830], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Ranai', region: 'kepri' },
  { name: 'Puskesmas Ranai', latlng: [3.9352, 108.3814], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'ibu', 'anak'] }, city: 'Ranai', region: 'kepri' },
  { name: 'Puskesmas Pulau Laut', latlng: [3.9028, 108.3514], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Natuna', region: 'kepri' },
  { name: 'RSUD Raja Ahmad Tabib', latlng: [0.9167, 104.4583], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Tanjung Pinang', region: 'kepri' },
  { name: 'Puskesmas Tanjungpinang', latlng: [0.9167, 104.4583], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'ibu', 'anak'] }, city: 'Tanjung Pinang', region: 'kepri' },
  { name: 'Puskesmas Tanjungpinang Barat', latlng: [0.9215, 104.4509], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Tanjung Pinang', region: 'kepri' },
  { name: 'Puskesmas Batu X', latlng: [0.9239, 104.4464], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak', 'ibu'] }, city: 'Tanjung Pinang', region: 'kepri' },
  { name: 'Puskesmas Tanjung Unggat', latlng: [0.9301, 104.4556], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Tanjung Pinang', region: 'kepri' },
  { name: 'Puskesmas Batu Aji', latlng: [1.0569, 104.0566], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak', 'ibu'] }, city: 'Batam', region: 'kepri' },
  { name: 'Puskesmas Lubuk Baja', latlng: [1.1340, 104.0125], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Batam', region: 'kepri' },
  { name: 'Puskesmas Sekupang', latlng: [1.0794, 103.9411], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Batam', region: 'kepri' },
  ...
  { name: 'Puskesmas Bulang', latlng: [1.0071, 103.9544], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Batam', region: 'kepri' },
  { name: 'RSUD Embung Fatimah', latlng: [1.0443, 104.0265], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Batam', region: 'kepri' },
  { name: 'RSJKO EHD KEPRI', latlng: [1.0169, 104.5184], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak'] }, city: 'Bintan', region: 'kepri' },
  { name: 'RSUD Tarempa', latlng: [3.2212, 106.2778], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Tarempa', region: 'kepri' },
  { name: 'Puskesmas Tarempa', latlng: [3.2231, 106.2762], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak', 'ibu'] }, city: 'Tarempa', region: 'kepri' },
  { name: 'RSUD Palmatak', latlng: [3.0336, 106.2574], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum'] }, city: 'Palmatak', region: 'kepri' },
  { name: 'Puskesmas Palmatak', latlng: [3.0318, 106.2539], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Palmatak', region: 'kepri' },
  { name: 'Puskesmas Letung', latlng: [3.2236, 106.2178], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'ibu', 'anak'] }, city: 'Letung', region: 'kepri' },
  { name: 'Puskesmas Dabo', latlng: [-0.5471, 104.4083], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Dabo', region: 'kepri' },
  { name: 'RSUD Dabo Lingga', latlng: [-0.5478, 104.4099], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak'] }, city: 'Dabo', region: 'kepri' },
  { name: 'Puskesmas Karimun', latlng: [1.0160, 103.4321], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Karimun', region: 'kepri' },
  { name: 'RSUD Karimun', latlng: [1.0168, 103.4310], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'ibu'] }, city: 'Karimun', region: 'kepri' },
  { name: 'RSAL Dr. Mintohardjo', latlng: [-6.2095, 106.8170], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Jakarta Pusat', region: 'dki' },
  { name: 'RSPAL dr. Ramelan', latlng: [-7.3088, 112.7427], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'trauma', 'anak', 'ibu'] }, city: 'Surabaya', region: 'jatim' },
  { name: 'RSAL Jala Ammari', latlng: [-5.1432, 119.4306], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'anak'] }, city: 'Makassar', region: 'sulsel' },
  { name: 'KRI dr. Wahidin Sudirohusodo', latlng: [-7.2500, 112.7500], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'trauma', 'anak', 'ibu'] }, city: 'Surabaya', region: 'jatim' },
  { name: 'RSPAD Gatot Soebroto', latlng: [-6.1697, 106.8354], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AD', services: ['igd', 'umum', 'trauma', 'anak', 'ibu'] }, city: 'Jakarta Pusat', region: 'dki' },
  { name: 'RS Bhayangkara Tk. I Pusdokkes Polri', latlng: [-6.2693, 106.8698], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'POLRI', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Jakarta Timur', region: 'dki' },
  { name: 'RS Bhayangkara Pondok Pinang', latlng: [-6.2878, 106.7815], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'POLRI', services: ['igd', 'umum'] }, city: 'Jakarta Selatan', region: 'dki' },
  { name: 'RS Bhayangkara Prof. Dr. Awaludin Djamin', latlng: [-6.9669, 110.5096], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'POLRI', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Semarang', region: 'jateng' },
  { name: 'RS Bhayangkara H. S. Samsoeri Mertojoso', latlng: [-7.2849, 112.7390], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'POLRI', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Surabaya', region: 'jatim' },
  { name: 'RS Dustira', latlng: [-6.8725, 107.5338], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AD', services: ['igd', 'umum', 'trauma', 'anak', 'ibu'] }, city: 'Cimahi', region: 'jabar' },
  { name: 'RSAL Jala Ammari', latlng: [-5.1450, 119.4340], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Makassar', region: 'sulsel' },
  { name: 'RSAL Dr. Mintohardjo Jakarta', latlng: [-6.2095, 106.8170], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Jakarta Pusat', region: 'dki' },
  { name: 'RSPAL dr. Ramelan Surabaya', latlng: [-7.3088, 112.7427], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', owner: 'TNI AL', services: ['igd', 'umum', 'trauma', 'anak', 'ibu'] }, city: 'Surabaya', region: 'jatim' },
  { name: 'RSUD Wakatobi', latlng: [-5.3193, 123.5948], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak'] }, city: 'Wangi-Wangi Selatan', region: 'sultra' },
  { name: 'Puskesmas Wangi-Wangi', latlng: [-5.3293, 123.5668], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'ibu', 'anak'] }, city: 'Wangi-Wangi', region: 'sultra' },
  { name: 'Puskesmas Kapota', latlng: [-5.3918, 123.6129], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Wakatobi', region: 'sultra' },
  { name: 'RSUD Maren Kota Tual', latlng: [-5.5679, 132.7659], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak', 'ibu'] }, city: 'Tual', region: 'maluku' },
  { name: 'Puskesmas Tual', latlng: [-5.6334, 132.7526], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak', 'ibu'] }, city: 'Tual', region: 'maluku' },
  { name: 'Puskesmas Dullah Laut', latlng: [-5.5798, 132.7509], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Tual', region: 'maluku' },
  { name: 'RSUD Biak', latlng: [-4.5973, 138.7660], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak'] }, city: 'Biak', region: 'papua' },
  { name: 'Puskesmas Biak Kota', latlng: [-1.1774, 136.0842], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'ibu', 'anak'] }, city: 'Biak', region: 'papua' },
  { name: 'Puskesmas Ohoijang Watdek', latlng: [-5.6459, 132.7367], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Kota Tual', region: 'maluku' },
  { name: 'RSUD Oksibil', latlng: [-4.7482, 140.4672], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum'] }, city: 'Oksibil', region: 'papua' },
  { name: 'Puskesmas Oksibil', latlng: [-4.7408, 140.4701], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum'] }, city: 'Oksibil', region: 'papua' },
  { name: 'RSUD Nabire', latlng: [-3.3600, 135.4970], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'anak'] }, city: 'Nabire', region: 'papua' },
  { name: 'Puskesmas Nabire', latlng: [-3.3665, 135.4946], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Nabire', region: 'papua' },
  { name: 'RSUD Merauke', latlng: [-8.4952, 140.4018], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum', 'ibu'] }, city: 'Merauke', region: 'papua' },
  { name: 'Puskesmas Merauke Kota', latlng: [-8.4964, 140.4039], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'ibu'] }, city: 'Merauke', region: 'papua' },
  { name: 'RSUD Kefamenanu', latlng: [-9.4484, 124.4780], tags: { amenity: 'hospital', healthcare: 'hospital', emergency: 'yes', services: ['igd', 'umum'] }, city: 'Kefamenanu', region: 'ntt' },
  { name: 'Puskesmas Kefamenanu', latlng: [-9.4489, 124.4758], tags: { amenity: 'clinic', healthcare: 'clinic', emergency: 'yes', services: ['umum', 'anak'] }, city: 'Kefamenanu', region: 'ntt' },
